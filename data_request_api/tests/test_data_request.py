...
class TestDRObjects(unittest.TestCase):
    ...
    def test_from_input(self):
        ...
        obj = DRObjects.from_input(
            dr=self.dr, id="link::my_id", DR_type="priority_level")
...
class TestExperimentsGroup(unittest.TestCase):
    ...
    def test_from_input(self):
        ...
        with self.assertRaises(ValueError):
            obj = ExperimentsGroup.from_input(
                id="link::my_id", dr=self.dr, experiments=["link::test", ])

        obj = ExperimentsGroup.from_input(id="link::my_id", dr=self.dr, experiments=[
                                          "link::default_291", "link::default_292"])
    ...
    def test_check(self):
        ...
        obj = ExperimentsGroup(id="link::my_id", dr=self.dr, experiments=[
                               "link::default_291", "link::default_292"])
        obj.check()
    ...
    def test_print(self):
        ...
        self.assertEqual(obj.print_content(
            level=1, add_content=False), ["    " + ref_str, ])
        self.assertEqual(obj.print_content(), ref_str_2)
        self.assertEqual(obj.print_content(level=1), [
                         "    " + elt for elt in ref_str_2])
    ...
    def test_eq(self):
        ...
        obj4 = ExperimentsGroup(id="link::my_id", dr=self.dr, experiments=[
                                "link::default_292", "link::default_301"])
    ...
    def test_filter_on_request(self):
        exp_grp1 = self.dr.find_element(
            "experiment_groups", "link::default_286")
        exp_grp2 = copy.deepcopy(exp_grp1)
        exp_grp3 = self.dr.find_element(
            "experiment_groups", "link::default_287")
...
class TestVariablesGroup(unittest.TestCase):
    ...
    def test_init(self):
        ...
        with self.assertRaises(ValueError):
            VariablesGroup("link::my_id", self.dr, name="test",
                           physical_parameter="link::my_link")
    ...
    def test_from_input(self):
        ...
        with self.assertRaises(ValueError):
            obj = VariablesGroup.from_input(
                id="link:my_id", dr=self.dr, variables=["link::test", ])
    ...
    def test_methods(self):
        obj = VariablesGroup.from_input(
            id="link::my_id", dr=self.dr, priority_level="High")
        self.assertEqual(obj.count(), 0)
        self.assertEqual(obj.get_variables(), list())
        self.assertEqual(obj.get_mips(), list())
        self.assertEqual(obj.get_priority_level(),
                         self.dr.find_element("priority_level", "High"))
        ...
        self.assertEqual(obj.get_mips(), [
                         self.dr.find_element("mips", "link::default_401")])
        self.assertDictEqual(
            obj.get_priority_level().attributes,
            {'name': "High", "notes": "High priority should be used sparingly", "value": 1, 'id': "default_481"})
    ...
    def test_eq(self):
        ...
        obj5 = VariablesGroup(id="link::my_id", dr=self.dr,
...
class TestOpportunity(unittest.TestCase):
    ...
    def test_from_input(self):
        ...
        with self.assertRaises(ValueError):
            obj = Opportunity.from_input(
                id="my_id", dr=self.dr, variable_groups=["test", ])

        obj = Opportunity.from_input(
            id="my_id", dr=self.dr, variable_groups=["link::default_577", "link::default_578"],
    ...
    def test_check(self):
        ...
        obj = Opportunity(id="my_id", dr=self.dr, variables_groups=[
                          "default_733", "default_734"])
        obj.check()
    ...
    def test_methods(self):
        ...
        obj = Opportunity.from_input(
            id="link::default_425", dr=self.dr, variable_groups=["link::default_577", "link::default_578"],
            experiment_groups=["link::default_285",],
            data_request_themes=["link::default_116", "link::default_117", "link::default_119"])
        self.assertListEqual(obj.get_experiment_groups(), [
                             self.dr.find_element("experiment_groups", "default_285")])
        ...
        self.assertListEqual(obj.get_themes(),
                             [self.dr.find_element("data_request_themes", "link::default_116"),
                              self.dr.find_element(
                                  "data_request_themes", "link::default_117"),
                              self.dr.find_element(
                                  "data_request_themes", "link::default_119")
                              ])

    def test_print(self):
        obj = Opportunity.from_input(
            id="link::default_420", dr=self.dr, name="Ocean Extremes",
    ...
    def test_eq(self):
        ...
        obj4 = Opportunity(id="my_id", dr=self.dr,
                           experiments_groups=["default_285", ])
        self.assertNotEqual(obj, obj4)

        obj5 = Opportunity(id="my_id", dr=self.dr, variables_groups=[
                           "default_733", "default_734"])
        self.assertNotEqual(obj, obj5)

        obj6 = Opportunity(id="my_id", dr=self.dr, themes=[
                           "default_104", "default_105", "default_106"])
        self.assertNotEqual(obj, obj6)
...
class TestDataRequest(unittest.TestCase):
    def setUp(self):
        ...
        self.input_database = read_json_input_file_content(
            self.input_database_file)
        self.complete_input_file = filepath("one_base_input.json")
        self.complete_input = read_json_input_file_content(
            self.complete_input_file)
    ...
    def test_from_input(self):
        ...
        with self.assertRaises(TypeError):
            DataRequest.from_input(
                self.complete_input_file + "tmp", version="test")

        obj = DataRequest.from_input(
            json_input=self.complete_input, version="test")
        self.assertEqual(len(obj.get_experiment_groups()), 5)
        self.assertEqual(len(obj.get_variable_groups()), 11)
        self.assertEqual(len(obj.get_opportunities()), 4)

        obj = DataRequest.from_input(
            json_input=self.complete_input_file, version="test")
        self.assertEqual(len(obj.get_experiment_groups()), 5)
        self.assertEqual(len(obj.get_variable_groups()), 11)
        self.assertEqual(len(obj.get_opportunities()), 4)
    ...
    def test_from_separated_inputs(self):
        ...
        with self.assertRaises(TypeError):
            DataRequest.from_separated_inputs(
                DR_input=self.input_database, VS_input=self.vs_file + "tmp")

        with self.assertRaises(TypeError):
            DataRequest.from_separated_inputs(
                DR_input=self.input_database_file + "tmp", VS_input=self.vs_dict)

        with self.assertRaises(TypeError):
            DataRequest.from_separated_inputs(
                DR_input=self.input_database_file, VS_input=self.vs)

        obj = DataRequest.from_separated_inputs(
            DR_input=self.input_database, VS_input=self.vs_dict)
        self.assertEqual(len(obj.get_experiment_groups()), 5)
        self.assertEqual(len(obj.get_variable_groups()), 11)
        self.assertEqual(len(obj.get_opportunities()), 4)

        obj = DataRequest.from_separated_inputs(
            DR_input=self.input_database_file, VS_input=self.vs_dict)
        self.assertEqual(len(obj.get_experiment_groups()), 5)
        self.assertEqual(len(obj.get_variable_groups()), 11)
        self.assertEqual(len(obj.get_opportunities()), 4)

        obj = DataRequest.from_separated_inputs(
            DR_input=self.input_database, VS_input=self.vs_file)
        self.assertEqual(len(obj.get_experiment_groups()), 5)
        self.assertEqual(len(obj.get_variable_groups()), 11)
        self.assertEqual(len(obj.get_opportunities()), 4)

        obj = DataRequest.from_separated_inputs(
            DR_input=self.input_database_file, VS_input=self.vs_file)
        self.assertEqual(len(obj.get_experiment_groups()), 5)
        self.assertEqual(len(obj.get_variable_groups()), 11)
        self.assertEqual(len(obj.get_opportunities()), 4)
    ...
    def test_split_content_from_input_json(self):
        ...
        with self.assertRaises(TypeError):
            DataRequest._split_content_from_input_json(
                self.input_database, version=self.vs)

        with self.assertRaises(TypeError):
            DataRequest._split_content_from_input_json(
                self.complete_input_file + "tmp", version="test")

        DR, VS = DataRequest._split_content_from_input_json(
            input_json=self.complete_input, version="test")
        self.assertDictEqual(DR, self.input_database)
        self.assertDictEqual(VS, self.vs_dict)

        DR, VS = DataRequest._split_content_from_input_json(
            input_json=self.complete_input_file, version="test")
        self.assertDictEqual(DR, self.input_database)
        self.assertDictEqual(VS, self.vs_dict)
    ...
    def test_version(self):
        ...
        self.assertEqual(
            obj.version, f"Software {version} - Content {self.input_database['version']}")
    ...
    def test_get_experiment_groups(self):
        ...
        self.assertListEqual(
            ...
            [obj.find_element("experiment_groups", id)
             for id
             in
             ["link::default_285", "link::default_286", "link::default_287", "link::default_288", "link::default_289"]])
    ...
    def test_get_filtering_structure(self):
        ...
        self.assertEqual(obj.get_filtering_structure("physical_parameters"),
                         {"opportunities", "variable_groups", "variables"})
...
class TestDataRequestFilter(unittest.TestCase):
    ...
    def test_element_per_identifier_from_vs(self):
        ...
        self.assertEqual(self.dr.find_element_per_identifier_from_vs(element_type="variables", key="name",
                         ...
                         target_var)
        with self.assertRaises(ValueError):
            self.dr.find_element_per_identifier_from_vs(
                element_type="variables", key="name", value="toto")
        with self.assertRaises(ValueError):
            self.dr.find_element_per_identifier_from_vs(
                element_type="variables", key="id", value="link::toto")
    ...
    def test_element_from_vs(self):
        ...
        name_var = "Omon.wo"
        target_var = self.dr.find_element("variables", id_var)
        self.assertEqual(self.dr.find_element_from_vs(
            element_type="variables", value=id_var), target_var)
        self.assertEqual(self.dr.find_element_from_vs(
            element_type="variables", value=name_var), target_var)
        with self.assertRaises(ValueError):
            self.dr.find_element_from_vs(
                element_type="variables", value="toto")
        with self.assertRaises(ValueError):
            self.dr.find_element_from_vs(
                element_type="variables", value="link::toto")
        self.assertEqual(self.dr.find_element_from_vs(
            element_type="variables", value="link::toto", default=None), None)
        self.assertEqual(self.dr.find_element_from_vs(
            element_type="variables", value="toto", default=None), None)
        with self.assertRaises(ValueError):
            self.dr.find_element_from_vs(
                element_type="opportunity/variable_group_comments", value="undef")
    ...
    def test_filter_elements_per_request(self):
        ...
        self.assertEqual(self.dr.filter_elements_per_request(
            "opportunities"), self.dr.get_opportunities())
        self.assertEqual(self.dr.filter_elements_per_request("opportunities", operation="any"),
                         self.dr.get_opportunities())
        with self.assertRaises(ValueError):
            self.dr.filter_elements_per_request(
                "opportunities", operation="one")

        with self.assertRaises(ValueError):
            self.dr.filter_elements_per_request(
                "opportunities", requests=dict(variables="link::test_dummy"))
        self.assertEqual(self.dr.filter_elements_per_request("opportunities",
                                                             requests=dict(
                                                                 variables="link::test_dummy"),
                                                             skip_if_missing=True), self.dr.get_opportunities())

    def test_find_variables_per_priority(self):
        priority = "Medium"
        priority_obj = self.dr.find_element(
            "priority_level", "link::default_482")
    ...
    def test_find_opportunities_per_theme(self):
        ...
        opportunities = [self.dr.get_opportunity(
            id) for id in ["link::default_418", ]]
        self.assertListEqual(
            self.dr.find_opportunities_per_theme(theme_id), opportunities)
        self.assertListEqual(
            self.dr.find_opportunities_per_theme(theme_name), opportunities)
        self.assertListEqual(self.dr.find_opportunities_per_theme(
            theme_target), opportunities)
        with self.assertRaises(ValueError):
    ...
    def test_find_experiments_per_theme(self):
        ...
        theme_name = "Atmosphere"
        theme_target = self.dr.find_element("data_request_themes", theme_id)
        exp = [self.dr.find_element("experiments", id) for id in [
            "link::default_310", "link::default_317"]]
        self.assertListEqual(self.dr.find_experiments_per_theme(theme_id), exp)
        self.assertListEqual(
            self.dr.find_experiments_per_theme(theme_name), exp)
        self.assertListEqual(
            self.dr.find_experiments_per_theme(theme_target), exp)
    ...
    def test_find_variables_per_theme(self):
        ...
        self.assertListEqual(
            self.dr.find_variables_per_theme(theme_target), var)
    ...
    def test_themes_per_opportunity(self):
        ...
        themes = [self.dr.find_element("data_request_themes", id) for id in [
            "link::default_115", "link::default_118"]]
        self.assertListEqual(
            self.dr.find_themes_per_opportunity(op_id), themes)
        self.assertListEqual(
            self.dr.find_themes_per_opportunity(op_name), themes)
        self.assertListEqual(
            self.dr.find_themes_per_opportunity(op_target), themes)
    ...
    def test_experiments_per_opportunity(self):
        ...
        exp = [self.dr.find_element("experiments", id) for id in [
            "link::default_310", "link::default_317"]]
        self.assertListEqual(
            self.dr.find_experiments_per_opportunity(op_id), exp)
        self.assertListEqual(
            self.dr.find_experiments_per_opportunity(op_name), exp)
        self.assertListEqual(
            self.dr.find_experiments_per_opportunity(op_target), exp)
    ...
    def test_variables_per_opportunity(self):
        ...
        var = [self.dr.find_element("variables", id) for id in ["link::83bbfc65-7f07-11ef-9308-b1dd71e64bec",
                                                                ...
                                                                "link::babb12ae-e5dd-11e5-8482-ac72891c3257"]]
        self.assertListEqual(
            self.dr.find_variables_per_opportunity(op_id), var)
        self.assertListEqual(
            self.dr.find_variables_per_opportunity(op_name), var)
        self.assertListEqual(
            self.dr.find_variables_per_opportunity(op_target), var)
    ...
    def test_mips_per_opportunity(self):
        ...
        self.assertListEqual(
            self.dr.find_mips_per_opportunity(op_target), mips)
    ...
    def test_opportunities_per_variable(self):
        ...
        op = [self.dr.find_element("opportunities", id)
              for id in ["link::default_420", ]]
        self.assertListEqual(
            self.dr.find_opportunities_per_variable(var_id), op)
        self.assertListEqual(
            self.dr.find_opportunities_per_variable(var_name), op)
        self.assertListEqual(
            self.dr.find_opportunities_per_variable(var_target), op)
    ...
    def test_themes_per_variable(self):
        ...
        self.assertListEqual(
            self.dr.find_themes_per_variable(var_name), themes)
        self.assertListEqual(
            self.dr.find_themes_per_variable(var_target), themes)
    ...
    def test_opportunities_per_experiment(self):
        ...
        op = [self.dr.find_element("opportunities", id) for id in [
            "link::default_420", "link::default_421"]]
        self.assertListEqual(
            self.dr.find_opportunities_per_experiment(exp_id), op)
        self.assertListEqual(
            self.dr.find_opportunities_per_experiment(exp_name), op)
        self.assertListEqual(
            self.dr.find_opportunities_per_experiment(exp_target), op)
    ...
    def test_themes_per_experiment(self):
        ...
        themes = [self.dr.find_element("data_request_themes", id) for id in ["link::default_116", "link::default_117",
                                                                             "link::default_119"]]
        self.assertListEqual(
            self.dr.find_themes_per_experiment(exp_id), themes)
        self.assertListEqual(
            self.dr.find_themes_per_experiment(exp_name), themes)
        self.assertListEqual(
            self.dr.find_themes_per_experiment(exp_target), themes)
